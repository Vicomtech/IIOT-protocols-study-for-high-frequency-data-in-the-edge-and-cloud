...
This project tests different protocols (AMQP, MQTT, ZEROMQ, KAFKA) simulating high frequency data under 2 different scenarios: edge and cloud. The data flow is the following:
